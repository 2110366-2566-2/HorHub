...
const CreateRoomTypePage = () => {
  ...
  <div className="page">
      ...
      <form className="flex flex-col " onSubmit = {handleSubmit(onSubmit)} >
          ...
          <div className="border-b border-slate-300 my-2 font-bold text-left pt-2">Room Properties</div>
          ...
          <CheckboxesInput fieldName='Please select all facilities in this room' name='roomFacilities' choices={availableRoomFacilities} register={register} />
